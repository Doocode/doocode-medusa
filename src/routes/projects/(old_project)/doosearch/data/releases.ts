import { type Release, ReleaseType } from '$routes/projects/core';
...
export const v1_3_2: Release = {
	...
	get description() {
		return m['projects.doosearch.releases.v1_3_2.description']();
	},
	get features() {
		return [
...
export const v1_3_1: Release = {
	...
	type: ReleaseType.Stable,
	get description() {
		return m['projects.doosearch.releases.v1_3_1.description']();
	},
	get features() {
		return [m['projects.doosearch.releases.v1_3_1.features.0']()];
	},
	get improvements() {
		return [
	...
	bugfixes: [],
	get removals() {
		return [m['projects.doosearch.releases.v1_3_1.removals.0']()];
	}
...
export const v1_3_0: Release = {
	...
	type: ReleaseType.Stable,
	get description() {
		return m['projects.doosearch.releases.v1_3_0.description']();
	},
	get breakingChanges() {
		return [];
	},
...
export const v1_2: Release = {
	...
	type: ReleaseType.Stable,
	get description() {
		return m['projects.doosearch.releases.v1_2.description']();
	},
	bugfixes: [],
	get features() {
		return [
...
export const releases: Release[] = [v1_3_2, v1_3_1, v1_3_0, v1_2];
